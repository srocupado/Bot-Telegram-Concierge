...
TOOLS: list[Tool] = [
    ...
    Tool(
        ...
        description=(
            ...
            "meus gastos da semana e quanto sobrou no orçamento'. CASO "
            "ESPECIAL: se o usuário pediu pra agendar um COMANDO do bot "
            "(ex.: 'agenda o /mp_dou_agora pras 10h'), passe o comando "
            "LITERAL com a barra em parametros (ex.: parametros='/mp_dou_agora "
            "05/08/2026') — ele é executado direto pelo handler do comando, "
            "sem interpretação, exatamente como se o usuário o digitasse.\n"
