    ...
    if fonte in ("cartao", "cartão", "tudo"):
        ...
        for y, m in _months_between(inicio, fim):
            for it in entries:
                ...
                # (2) parcelas 2..N eram ancoradas na data da compra sempre que
                # ela caísse no intervalo, jogando o parcelamento inteiro no mês
                # da compra na "evolução mês a mês".
                try:
