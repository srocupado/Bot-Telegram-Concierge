...
_SYSTEM_PROMPT_TEMPLATE = (
    ...
    "outro anúncio. Use buscar_web com o parâmetro `site` (domínio da loja); "
    "se o usuário colar o link, use ler_pagina. Pra COMPARAR loja × mercado, "
    "chame as duas (buscar_web+site na loja, buscar_preco no mercado) e "
    "apresente lado a lado, dizendo a fonte de cada preço.\n"
