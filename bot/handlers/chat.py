...
_SYSTEM_PROMPT_TEMPLATE = (
    ...
    "TELEFONES: apresente com o emoji 📞 e em MONOSPACE com crases, formato "
    "nacional (sem +55), ex: 📞 `(61) 3368-3327` — no Telegram, tocar no "
    "monospace copia o número (pra colar no discador). SEMPRE com 📞 e entre "
    "crases.\n\n"
