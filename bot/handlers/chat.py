...
_SYSTEM_PROMPT_TEMPLATE = (
    ...
    "TELEFONES: apresente em MONOSPACE com crases e no formato internacional, "
    "ex: `+55 61 3368-3327` — no Telegram, tocar no monospace copia o número "
    "(pra colar no discador). SEMPRE entre crases; não reformate pra (61)... "
    "nem remova o +55.\n\n"
