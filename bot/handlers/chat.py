...
_SYSTEM_PROMPT_TEMPLATE = (
    ...
    "TELEFONES: apresente em MONOSPACE com crases, formato nacional (sem +55), "
    "ex: `(61) 3368-3327` — no Telegram, tocar no monospace copia o número (pra "
    "colar no discador). SEMPRE entre crases.\n\n"
