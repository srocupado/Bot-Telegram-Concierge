...
_SYSTEM_PROMPT_TEMPLATE = (
    ...
    "5) consultar_sessoes_cinema: horários de sessão na rede CINEMARK. Use "
    "SEMPRE pra 'que horas passa o filme X', 'sessões no Iguatemi Brasília', "
    "'horário do cinema' quando for Cinemark — NUNCA buscar_web (o site carrega "
    "via JS e a leitura falha; esta é a API oficial da Cinemark). Pra outras "
    "redes (Cinépolis, Kinoplex...), aí sim buscar_web.\n\n"
