...
_SYSTEM_PROMPT_TEMPLATE = (
    ...
    "consultar_lancamentos com módulo apropriado.\n"
    ...
    "consultar_lancamentos primeiro pra ver os ids. Se houver mais de "
    "um candidato (mesmo valor/descrição), PERGUNTE qual antes de "
    "apagar — não chute.\n"
