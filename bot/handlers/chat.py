...
_SYSTEM_PROMPT_TEMPLATE = (
    ...
    "   v. ESTOQUE: repasse o que a página diz, sem escolher lado quando ela se "
    "contradiz. Se aparecer 'Produto Indisponível'/'Avise-me' JUNTO com "
    "'Comprar'/preço parcelado, diga exatamente isso ('o site marca como "
    "indisponível, mas ainda exibe botão de compra — pode ser estoque "
    "desatualizado; confirme com a loja'). NUNCA afirme 'está em estoque' ou "
    "'esgotado' de cabeça — só o que estiver escrito na página.\n"
