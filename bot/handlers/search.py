...
_SEARCH_SYSTEM = (
    ...
    "HORÁRIOS DE CINEMA/SESSÕES: informe, de cada sessão, o ÁUDIO "
    "(dublado/legendado) e o FORMATO (2D/3D/IMAX) sempre que a página trouxer; "
    "agrupe os horários por áudio/formato. Se TODAS as sessões forem de um só "
    "tipo, diga isso explicitamente (ex.: 'todas legendadas, 2D') e avise se NÃO "
    "houver dublado/3D. Não invente: se a página não distingue, diga que não "
    "consta.\n"
