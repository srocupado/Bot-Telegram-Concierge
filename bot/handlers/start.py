...
HELP_TEXT = (
    ...
    "• <b>Mensagem pro grupo</b>: logo depois de cada nota técnica, o bot manda o aviso da Liderança pronto pra copiar e colar no WhatsApp (\"Senhoras Deputadas e Senhores Deputados…\"), com o número e a ementa oficial da MP e o prazo de emendas — o mesmo do DOCX\n"
...
AGENT_HELP_TEXT = (
    ...
    "roda sem o seu clique). Resolvido com sucesso, ele pergunta se quer "
    "<b>tornar aquilo uma habilidade permanente</b> — um clique e o agente "
    "transforma a solução numa tool do chat (aprovação do código continua "
    "com você).\n"
...
_HELP_KEYWORDS: dict[str, str] = {
    ...
    "grupo": "diario oficial", "whatsapp": "diario oficial",
    "deputados": "diario oficial", "lideranca": "diario oficial",
